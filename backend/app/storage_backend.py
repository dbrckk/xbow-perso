...
class StorageBackend(Protocol):
    ...
    def put_recovery_readiness_snapshot(self, fingerprint: str, decision: str, document: dict) -> dict: ...
    def list_recovery_readiness_snapshots(self, *, limit: int = 100) -> list[dict]: ...
    def put_control_plane_health_snapshot(self, fingerprint: str, score: int, state: str, document: dict) -> dict: ...
    def list_control_plane_health_snapshots(self, *, limit: int = 100) -> list[dict]: ...
