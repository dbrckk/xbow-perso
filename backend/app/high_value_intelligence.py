...
_CASES = (
    ...
    PublicCaseLesson(
        case_id="coinbase-stellar-reconciliation-2026",
        family="transaction-reconciliation-invariants",
        title="Protocol transaction state diverged from internal withdrawal reconciliation",
        source_url="https://www.coinbase.com/blog/consumer-protection-tuesday-ai-and-human-expertise",
        ...
        observation_goals=(
            "map each externally visible transaction state to the corresponding internal state transition",
            "compare retry, replacement, fee-bump, and wrapped-transaction outcomes without moving third-party funds",
            "look for success/failure disagreement between protocol settlement and application reconciliation",
            "treat idempotency, replay, and accounting invariants as first-class business-logic boundaries",
        ),
    ),
    PublicCaseLesson(
