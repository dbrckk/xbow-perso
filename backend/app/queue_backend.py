...
class QueueBackend(Protocol):
    ...
    def job_transitions(self, job_id: str) -> list[dict]: ...
    def verify_job_transitions(self, job_id: str) -> dict: ...
    def campaign_transition_audit(self, campaign_id: str) -> dict: ...
    def recovery_assessment(self) -> dict: ...
