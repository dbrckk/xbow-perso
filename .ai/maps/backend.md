...
## File: app/campaign_chain_priority.py
```python
_FAMILY_TO_CATEGORY = {
⋮----
...
## File: app/hackerone_attention.py
```python
TERMINAL_BUCKETS = {
...
## File: app/hackerone_feasibility.py
```python
_next_attempt_monotonic = 0.0
⋮----
_CAPABILITY_GAPS = {
...
## File: app/high_value_intelligence.py
```python
router = APIRouter()
⋮----
@dataclass(frozen=True)
...
## File: app/opportunity_ranking.py
```python
...
## File: app/passive_api_intelligence.py
```python
...
## File: app/planner_intelligence.py
```python
...
## File: app/report_approval_api.py
```python
router = APIRouter()
⋮----
...
## File: tests/test_campaign_chain_priority.py
```python
...
## File: tests/test_hackerone_attention.py
```python
...
## File: tests/test_hackerone_batch_api.py
```python
...
## File: tests/test_hackerone_catalog.py
```python
class FakeClient
⋮----
...
## File: tests/test_hackerone_feasibility.py
```python
class _Store
⋮----
...
## File: tests/test_hackerone_prelaunch.py
```python
...
## File: tests/test_hackerone_report_sync_worker.py
```python
class _Client
⋮----
...
## File: tests/test_high_value_intelligence.py
```python
def _focuses(graph)
⋮----
...
## File: tests/test_identity_access.py
```python
...
## File: tests/test_opportunity_ranking.py
```python
...
## File: tests/test_passive_api_intelligence.py
```python
...
## File: tests/test_passive_high_value_ranking.py
```python
...
## File: tests/test_planner_intelligence.py
```python
...
## File: tests/test_recon_priority.py
```python
...
## File: tests/test_report_approval_api.py
```python
...
## File: tests/test_route_registration_uniqueness.py
```python
...
## File: tests/test_target_memory.py
```python
class FakeStore
⋮----
def __init__(self, campaigns, observations)
